...
Built with data from GenBank release 261 (cutoff date 2024-06-15). Includes 635 complete plastome sequences and 5,850 tips total.

- [zip](https://github.com/fernphy/ftol_data/archive/refs/tags/v1.7.0.zip)
- [tar.gz](https://github.com/fernphy/ftol_data/archive/refs/tags/v1.7.0.tar.gz)

### v1.6.0

Built with data from GenBank release 259 (cutoff date 2023-12-17). Includes 602 complete plastome sequences and 5,785 tips total.

- [zip](https://github.com/fernphy/ftol_data/archive/refs/tags/v1.6.0.zip)
- [tar.gz](https://github.com/fernphy/ftol_data/archive/refs/tags/v1.6.0.tar.gz)
